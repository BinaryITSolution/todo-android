package com.dewan.todoapp.view.ui.darkmode
...
import com.dewan.todoapp.util.AppThemeMode
...
class DarkModeFragment : DialogFragment(), RadioGroup.OnCheckedChangeListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //pref
        sharedPreferences = activity!!.getSharedPreferences(BuildConfig.PREF_NAME,Context.MODE_PRIVATE)
